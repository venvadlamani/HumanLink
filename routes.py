...
routes = [
    ...
    webapp2.Route(r'/post_connection_request', name='post_connection_request',
                  methods=['POST'],
                  handler='controllers.accounts.Accounts:POST_connection_request'),

    webapp2.Route(r'/post_connection_accept', name='post_connection_accept',
                  methods=['POST'],
